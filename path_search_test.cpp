...
int main()
{
    ...
    // 添加3个图对应的测试数据
    cases.add_case_test(0, "4", "0", {"1","5"}, {"red","blue","blue","green"});
    cases.add_case_test(0, "5", "0", {"4","4"}, {"red","red","red","green","blue"});

    cases.add_case_test(1, "3", "5", {"0"}, {"red","red","blue","blue"});
    cases.add_case_test(1, "5", "0", {}, {"red","red","green","green","blue"});
    cases.add_case_test(1, "5", "0", {"3","4"}, {"red","green","green","green","green","blue"});
    cases.add_case_test(1, "4", "5", {"0","1","5","5"}, {"red","red","red","green","green","blue"});

    cases.add_case_test(2, "9", "4", {"0","7"}, {"red","red","green","green","blue"});
    cases.add_case_test(2, "2", "8", {"0","4"}, {"red","green","green","blue","blue","blue"});
    cases.add_case_test(2, "5", "8", {"6","9"}, {"red","green","green","green","blue","blue"});
    cases.add_case_test(2, "3", "0", {"2","4","9"}, {"red","red","red","green","green","blue","blue"});
    cases.add_case_test(2, "1", "8", {"2","3","6"}, {"red","red","green","green","green","green","blue"});
